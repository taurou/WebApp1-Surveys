  ...
  return (
    <Navbar className="fixed-top" bg="info">
      ...
      <Navbar.Collapse className="justify-content-end">
        <Link to="/adminpanel"> <Button className="toprightbutton text-white" variant="success" >
        ...
        {props.login ? <Button className="toprightbutton text-white" variant="danger" onClick={props.logout}><svg className="bi bi-people-circle" width="20" height="20" viewBox="0 0 16 16" fill="white" xmlns="http://www.w3.org/2000/svg">
