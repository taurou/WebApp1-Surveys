...
function Surveys(props) {
  ...
  return (
    <>
      ...
      <Link to="/adminpanel/newsurvey"><Button variant="success" className="fixed-right-bottom" ><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-plus-square-dotted" viewBox="0 0 16 16">
